package com.example.sensorstracker.ui.mechanic.map
...
class MechanicMapFragment : Fragment() {
    val viewModel : MechanicMapViewModel by viewModel()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.toolbar_title).text = "Mechanic"
